...
typedef enum{
    ...
    ArmBandCmdGetAge,            // 获取年龄
    ArmBandCmdSetAge,            // 设置年龄
    ArmBandCmdSetShock,          // 设置震动阈值
    ArmBandCmdGetShock,          // 获取震动阈值
    ArmBandCmdCloseShock,        // 关闭震动功能
    ArmBandCmdSetMaxInterval,    // 设置心率区间最大值
    ArmBandCmdGetMaxInterval,    // 获取心率区间最大值
    ArmBandCmdSetLightSwitch,       // 设置呼吸灯的开关
    ArmBandCmdGetLightSwitch,    // 获取呼吸灯的开关
    ArmBandCmdGetSetting,        // 获取设置信息
